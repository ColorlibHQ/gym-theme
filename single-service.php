...
get_header();
$services_meta = ! empty( gym_meta( 'service_accordions') ) ? gym_meta( 'service_accordions') : '';
$service_faqs = ! empty( gym_meta( 'service_faqs') ) ? gym_meta( 'service_faqs') : '';
$brochure = ! empty( gym_meta( 'brochure') ) ? gym_meta( 'brochure') : '';
$download_icon = GYM_DIR_ICON_IMG_URI . 'download.svg';
$count = 0;
if( have_posts() ) {
                                    ...
                                    <div class="service_thumb">
                                        <?php
                                            if( $single_item['image_id'] ) {
                                                echo wp_get_attachment_image( $single_item['image_id'], 'gym_service_details_thumb_754x410', '', array('alt' => get_the_title() ) );
                                            }
                                        ?>
                                    </div>
                                </div>
