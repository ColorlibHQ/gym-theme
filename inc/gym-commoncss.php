...
// enqueue css
function gym_common_custom_css(){
    
    wp_enqueue_style( 'gym-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= gym_opt( 'gym_theme_color' ) != '#131313' ? gym_opt( 'gym_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= gym_opt( 'gym_book_btn_color' ) != '#131313' ? gym_opt('gym_book_btn_color') : '';
		$bookBtnHoverBgColor     	= gym_opt( 'gym_book_btn_hvr_bg_color' ) != '#131313' ? gym_opt('gym_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = gym_opt( 'gym_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = gym_opt( 'gym_navbar_bg_color' ) != '#082b49' ? gym_opt( 'gym_navbar_bg_color') : '';
		$headerTop_col     		  = gym_opt( 'gym_top_header_color' );

		$headerTopBg      		  = gym_opt( 'gym_top_header_bg_color');
		$headerBg          		  = gym_opt( 'gym_header_bg_color') != '#ffffff' ? gym_opt( 'gym_header_bg_color') : '';
		$menuColor          	  = gym_opt( 'gym_header_menu_color' ) != '#131313' ? gym_opt('gym_header_menu_color') : '';
		$menuHoverColor           = gym_opt( 'gym_header_menu_hover_color' ) != '#808080' ? gym_opt('gym_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = gym_opt( 'gym_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = gym_opt( 'gym_header_drop_menu_bg_color' ) != '#ffffff' ? gym_opt('gym_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = gym_opt( 'gym_dropdown_menu_color' ) != '#131313' ? gym_opt('gym_dropdown_menu_color') : '';
		$dropMenuHovColor         = gym_opt( 'gym_dropdown_menu_hover_color' ) != '#808080' ? gym_opt('gym_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = gym_opt( 'gym_footer_widget_bg_color' );
		$footerwHeadColor   	  = gym_opt('gym_footer_widget_heading_color');
		$footerwTextColor   	  = gym_opt('gym_footer_widget_text_color');
		$footerwanchorcolor 	  = gym_opt('gym_footer_widget_anchor_color') != '#ffffff' ? gym_opt('gym_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = gym_opt('gym_footer_widget_anchor_hover_color') != '#ffffff' ? gym_opt('gym_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = gym_opt('gym_fof_bg_color');
		$foftonecolor			  = gym_opt('gym_fof_textone_color');
		$fofttwocolor			  = gym_opt('gym_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = gym_opt('gym_footer_widget_anchor_color') != '#9e9e9e' ? gym_opt('gym_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .gym_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .gym_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'gym-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'gym_common_custom_css', 50 );