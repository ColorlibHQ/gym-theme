...
// image default alt
if ( ! function_exists( 'gym_img_default_alt' ) ) {
	function gym_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'gym_img_tag' ) ) {
	function gym_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'gym_anchor_tag' ) ) {
	function gym_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'gym_heading_tag' ) ) {
	function gym_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'gym_paragraph_tag' ) ) {
	function gym_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'gym_other_tag' ) ) {
	function gym_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'gym_button_element ' ) ) {
	function gym_button_element( array $args ) {
