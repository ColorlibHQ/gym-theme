 ...
 */
	...
	class gym_Enqueue{
		...
		public function gym_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'gym_frontend_enqueue_scripts', ) );
		}

		public function gym_frontend_enqueue_scripts( ){
